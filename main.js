...
function replaceWordsInTextNodes() {
    var wordsToReplace = ['Java', 'Javascript', 'Angular', 'React', 'Python', 'ML algorithms', 'ML-Algorithmen', 'HTML', 'CSS', 'SQL', 'Hibernate', 'JavaScript', 'University of Bremen', 'computer science'];
