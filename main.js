...
function replaceWordsInTextNodes() {
    var wordsToReplace = ['Java', 'Javascript', 'Angular', 'React', 'Python', 'ML algorithms', 'ML-Algorithmen', 'ML algoritmaları', 'HTML', 'CSS', 'SQL', 'Hibernate', 'JavaScript', 'University of Bremen', 'computer science', 'Informatik', 'bilgisayar bilimi', 'Git', 'database', 'Linux', 'TypeScript', 'Firebase'];
